...
defineEmits<{ (e: 'change', sorting: Sorting): void }>()
...
const sortings: { sort: Sorting; icon: string }[] = [
  ...
  {
    sort: 'top',
    icon: 'i-material-symbols-verified',
  },
  {
    sort: 'cheapest',
...
<template>
  <ul class="mt-4 flex justify-center gap-2 font-semibold">
